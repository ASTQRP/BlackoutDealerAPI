INSERT INTO `Brands` (`BrandID`, `BrandCode`, `BrandName`) VALUES
(1, 'ACURA', 'Acura'),
(2, 'ALFA', 'Alfa Romeo'),
(3, 'AMC', 'AMC'),
...
(70, 'VOLVO', 'Volvo'),
(71, 'YUGO', 'Yugo');
INSERT INTO `models` (`ModelID`, `BrandID`, `ModelCode`, `ModelName`) VALUES
...
INSERT INTO `VehicleTypes` (VehicleTypeID, VehicleTypeName) VALUES (1,'On Sale'),(2,'On rent'),(3,'Crashed Car');
insert INTO `Vehicles`
(`VehicleID`, `BrandID`, `ModelID`, `TypeID`, VehicleYear, VehiclePrice, VehicleOnRent, VehicleDescription) VALUES
(0, 11, 264,1,2019,35000,false,'On Sale'),
(0, 11, 238,1,2020,40000,false,'On Sale'),
(0, 11, 251,1,2019,35000,false,'On Sale'),
(0, 11, 254,1,2020,40000,false,'On Sale'),
(0, 11, 258,1,2019,35000,false,'On Sale'),
(0, 11, 261,1,2020,40000,false,'On Sale'),
(0, 11, 266,2,2012,23,true,'On Rent'),
(0, 11, 253,2,2013,30,true,'On Rent'),
(0, 11, 256,2,2010,70,true,'On Rent'),
(0, 11, 257,2,2012,23,true,'On Rent'),
(0, 11, 266,2,2013,30,true,'On Rent'),
(0, 11, 263,2,2012,23,true,'On Rent'),
(0, 11, 260,2,2013,30,true,'On Rent'),
(0, 5, 57,2,2012,23,true,'On Rent'),
(0, 5, 58,2,2013,30,true,'On Rent'),
(0, 5, 59,2,2010,70,true,'On Rent'),
(0, 5, 60,2,2012,23,true,'On Rent'),
(0, 5, 61,2,2013,30,true,'On Rent'),
(0, 5, 62,2,2012,23,true,'On Rent'),
(0, 5, 63,2,2013,30,true,'On Rent'),
(0, 11, 266,3,2010,7000,false,'Crashed Cars'),
(0, 11, 262,3,2010,7000,false,'Crashed Cars'),
(0, 11, 265,3,2010,7000,false,'Crashed Cars'),
(0, 11, 252,3,2010,7000,false,'Crashed Cars'),
(0, 11, 259,3,2010,7000,false,'Crashed Cars');